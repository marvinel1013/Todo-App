  ...
  return (
    <div className="fixed z-10 bg-black bg-opacity-40 top-0 left-0 bottom-0 w-full flex items-center justify-center px-3">
      <div className="bg-white h-[350px] w-[350px] rounded-lg p-5 px-7 relative">
        <div className="absolute cursor-pointer duration-300 hover:bg-red-500 right-0 top-[-45px] text-white bg-red-600 p-1.5 rounded-md">
          <MdClose size={25} />
        </div>
        ...
        <form>
          ...
          <div className="mt-5 flex gap-3">
            ...
            <button className="bg-redApp-0 p-3 px-4 rounded-lg text-white hover:opacity-90 duration-300">
              Cancel
            </button>
          </div>
        </form>
